...
-- Module 1: Authentication (Ahmad Ali)
CREATE TABLE users (
...
-- Default login accounts (Module 1 - Ahmad Ali)
-- admin / admin123  |  staff1 / staff123
INSERT INTO users (username, password, full_name, role) VALUES
('admin',  'admin123', 'Admin User',   'admin'),
('staff1', 'staff123', 'Sara Khan',    'staff'),
('staff2', 'staff123', 'Usman Tariq',  'staff');
